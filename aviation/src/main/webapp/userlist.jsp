        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for(var i=0;i<result.length;i++){
                    $("#tby").append("<tr><td><label><input type=\"checkbox\" class=\"ace\"><span class=\"lbl\"></span></label></td><td>"+result[i].aid+"</td><td>"+result[i].username+"</td><td>"+result[i].aname+"</td><td>"+result[i].age+"</td><td>"+result[i].tel+"</td><td>"+result[i].qq+"</td><td >"+result[i].tel+"</td><td>"+result[i].role_id+"</td><td>"+result[i].add_time+"</td><td class=\"td-status\"><span class=\"label label-success radius\">正常</span></td>"+"<td class=\"td-manage\"><a onClick=\"member_stop(this,'10001')\"  href=\"javascript:;\" title=\"停用\"  class=\"btn btn-xs btn-success\"><i class=\"icon-ok bigger-120\"></i></a><a title=\"编辑\" onclick=\"member_edit("+result[i].aid+")\" href=\"javascript:;\"  class=\"btn btn-xs btn-info\" ><i class=\"icon-edit bigger-120\"></i></a> <a title=\"删除\" href=\"javascript:;\"  onclick=\"member_del(this,'1')\" class=\"btn btn-xs btn-warning\" ><i class=\"icon-trash  bigger-120\"></i></a></td></tr>");
                }
            }
        })
    })
